(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
    [33786, 15483, 73105], {
        ...
        591800: (e, o, t) => {
            ...
            var r = t(23482);
            const s = r.isMac || r.isIOS;
            var l;

            function i(e) {
                let o = 0;
                return e.shiftKey && (o += 1024), e.altKey && (o += 512), e.ctrlKey && (o += 256), e.metaKey && (o += 2048), o
            }

            function a(e) {
                return i(e) | e.keyCode
            }! function(e) {
                e[e.None = 0] = "None", e[e.Alt = 512] = "Alt", e[e.Shift = 1024] = "Shift", e[e.Mod = s ? 2048 : 256] = "Mod", e[e.Control = 256] = "Control", e[e.Meta = 2048] = "Meta"
            }(l || (l = {}));
            const n = {
                    9: "⇥",
                    13: "↵",
            ...
            for (let e = 1; e <= 16; e++) n[e + 111] = `F${e}`, c[e + 111] = `F${e}`;

            function d(e) {
                let o = function(e, o = !s) {
                    let t = "";
                    return 256 & e && (t += h(s ? "^" : "Ctrl", o)), 512 & e && (t += h(s ? "⌥" : "Alt", o)), 1024 & e && (t += h(s ? "⇧" : "Shift", o)), 2048 & e && (t += h(s ? "⌘" : "Win", o)), t
                }(e);
                const t = 255 & e;
                return o += t in n ? n[t] : String.fromCharCode(t), o
            }
        ...
        927301: (e, o, t) => {
            ...
            const r = /[<"'&>]/g,
                ...
                a = new RegExp(Object.keys(l).join("|"), "g");
            new RegExp(Object.keys(i).join("|"), "g");

            function n(e) {
                return e.replace(a, (e => l[e] || e))
            }
        ...
        780792: (e, o, t) => {
            ...
            class a {
                ...
                _updateValue(e, o) {
                    ...
                    (o || t !== this._value) && (this._value = t, this._onValueChange ? .(this._value))
                }
                _renderClasses() {
        ...
        719240: (e, o, t) => {
            ...
            class n extends s.AbstractIndicator {
                ...
                _getValueFromData(e) {
                    let o;
                    return o = void 0 !== e.values && void 0 !== e.values.update_mode ? e.values.update_mode : this.getValue(), a[o] || o
                }
                _updateValue(e, o) {
        ...
        600303: (e, o, t) => {
            ...
            class a extends s.AbstractIndicator {
                constructor(e) {
                    super(e), this._quoteSessionPrefix = "market-status-indicator", this._componentClass = "tv-market-status", this._extraTitle = "",
                        this._init(e)
                }
                setStatus(e, o) {
                    const t = {
        ...
        345848: (e, o, t) => {
            ...
            t(251954);
            var r = t(931924);
            const s = (0, t(735566).getLogger)("Common.TrackEvent");
            let l = !1;
            const i = (e, o, t) => {
                if (l) return;
                let i = (e ? e + ":" : "") + o;
            ...
            class l {
                ...
                format(e, o) {
                    ...
                    const {
                        ...
                        precision: i,
                        minPrecision: a
                    } = this._options, n = (0, s.getNumberFormat)(t || o ? .ignoreLocaleNumberFormat);
                    return void 0 === i ? l._formatNoEImpl(e, n, i, a) : (0, r.formatNumber)(e, n, i, void 0, a)
                }
                parse(e, o) {
                    const {
                        ignoreLocaleNumberFormat: t,
                        precision: l
                    } = this._options, i = (0, s.getNumberFormat)(t || o ? .ignoreLocaleNumberFormat);
                    let a = (0, r.parseNumber)(e, i);
                    return Number.isFinite(a) ? (l && (a = +a.toFixed(l)), {
                        res: !0,
                        value: a
                    }) : {
                        res: !1
        ...
        280355: (e, o, t) => {
            ...
            ! function(e) {
                ...
                e.formatSign = o, e.formatDiff = function(e, t) {
                    ...
                    if (null === c) return i.appendChild(l(a)), i;
                    const d = l(a.substring(0, c)),
                        h = document.createElement("span");
                    return h.className = t < 0 ? r : s, h.appendChild(l(a.substring(c))), i.appendChild(d), i.appendChild(h), i
                }
            }(r || (r = {}))
        },
        51196: (e, o, t) => {
            ...
            function n(e, o) {
                const t = e - o;
                return a.find((e => e.value >= t)) ? ? a[a.length - 1]
            }
            class c {
                constructor(e = {}) {
                    this.type = "volume";
                    const {
                        precision: o = 0,
                        minPrecision: t = 0,
                        dimensionPrecision: r = 2,
                        dimensionMinPrecision: l = 0,
                        significantDigits: i = 3,
                    ...
                    this._precision = o,
                        this._formatter = new s.NumericFormatter({
                            ...
                            minPrecision: t
                        }), this._dimensionPrecision = r, this._dimensionFormatter = new s.NumericFormatter({
                            ignoreLocaleNumberFormat: a,
                            precision: this._dimensionPrecision,
                            minPrecision: l
                        }), this._significantDigits = i, this._fractionalValues = void 0 !== o && o > 0, this._spaceBeforeDimension = n ? "" : " ", this._options = e
                }
                state() {
                    const {
                ...
                format(e, o) {
                    ...
                    let s = "";
                    Math.abs(e) < 1 && (e = +e.toFixed(this._precision)), e < 0 ? s = "−" : e > 0 && o ? .signPositive && (s = "+"), e = Math.abs(e);
                    const a = !!(o ? .ignoreLocaleNumberFormat ? ? this._options.ignoreLocaleNumberFormat);
                    let c, d, h = Math.floor(Math.log10(e)) + 1;
                    if (h <= this._significantDigits && (e = +e.toFixed(this._precision), h = Math.floor(Math.log10(e)) + 1), h <= this._significantDigits) c = this._formatNumber(e, a, this._formatter);
                    else {
                        let o = n(h, this._significantDigits);
                        const t = Math.pow(10, o.value);
                        e = +(e / t).toFixed(this._dimensionPrecision) * t, o = n(Math.floor(Math.log10(e)) + 1, this._significantDigits), c = this._formatNumber(e / Math.pow(10, o.value), a, this._dimensionFormatter), d = o.letter
                    }
                    return d ? `${s}${c}${this._spaceBeforeDimension}${d}` : `${s}${c}`
                }
                parse(e, o) {
                    if ("---" === e) return {
                        error: "not a number",
        ...
        23203: (e, o, t) => {
            ...
            function c(e) {
                return (0, i.tokenize)(e).find((e => "symbol" === e.type)) ? .value
            }
            ...
            function p(e, o, t, l) {
                const i = (window.locale_domains ? (0, s.determineBaseUrl)(window.locale_domains, l) : window.location.origin) + h(e, d(n(o)));
        ...
        190209: (e, o, t) => {
            ...
            function _(e, o, t) {
                const r = (0, g.toNumberOrUndefined)(e);
                if ("economic" === o ? .type && 0 === r || void 0 === r) return;
                const s = t ? .customPriceFormatter || "volume" === o.format && new c.VolumeFormatter({
                        precision: 2
                    }) || new n.PriceFormatter({
                        priceScale: o.pricescale || 100,
                        minMove: o.minmov || 1,
                        fractional: o.fractional,
                        minMove2: o.minmove2
                    }),
                    l = void 0 !== t ? .signPositiveChange ? t.signPositiveChange : t ? .signPositive;
                return ((e, o = !0) => o ? `(${e})` : e)(s.format(r, {
                    signPositive: l,
                    signNegative: t ? .signNegative
                }), t ? .changeInBrackets)
            }
            var b = t(444372);
            ...
            var x = t(40763);
            const F = (0, s.getLogger)("QuoteTicker"),
                C = {
            ...
            function k(e, o, t = {}) {
                this.enabled = !0, this._symbol = e, this._symbolOriginal = null, this._options = (0, r.deepExtend)({}, C, t), !1 !== this._options.signNegative && !0 !== this._options.signNegative && delete this._options.signNegative,
                    t.customPriceFormatter && (this._customPriceFormatter = t.customPriceFormatter), t.customTimeFormatter && (void 0 !== t.customTimeFormatter.lastPrice || void 0 !== t.customTimeFormatter.rtc ? this._timeFormatter = t.customTimeFormatter : this._timeFormatter = {
                        lastPrice: t.customPriceFormatter,
                        rtc: t.customPriceFormatter
                    }), this._percentFormatter = new i.PercentageFormatter, this._defaultPriceFormatter = new n.PriceFormatter({
                        priceScale: 100
            ...
            function E(e, o, t, r, s) {
                ...
                return {
                    show: function(n) {
                        var c = 0;
                        if (n !== i) {
                            if (null !== i && null !== n && (c = n - i), a(), l = setTimeout(a, 750), 0 < c) {
                                if (o)
            ...
            k.prototype._setElements = function(e) {
                ...
                }, k.prototype.onData = function(e, o) {
                ...
                }, k.prototype.successData = function(e, o) {
                    e.values && this.setState(e.values, e, o)
                }, k.prototype.onPermissionDenied = function(e) {
                    (0, x.isSfQuoteData)(e) || function(e) {
                        return !!e && (f(e.symbolname) || "permission_denied" === e.status && f(e.values ? .alternative))
                ...
                }, k.prototype.errorData = function(e) {
                    ...
                    })))), this._options.noSuchSymbolHook ? (this._symbolOriginal && this.setShortName(this._symbolOriginal), this._options.noSuchSymbolHook.call(this, e, this._symbolOriginal || this._symbol)) : F.logWarn("No data for: " + this._symbol)
                }, k.prototype.downgradeData = function(e) {
                    {
                ...
                }, k.prototype.setState = function(e, o, r) {
                    const s = r.values;
                    this._isVolumeFormat = "volume" === e.format, null == s.pricescale && null == s.minmov && null == s.fractional && null == s.minmove2 || (this._priceFormatter = this._customPriceFormatter || this._isVolumeFormat && this._volumeFormatter || new n.PriceFormatter({
                    ...
                    const l = this._options,
                        ...
                        a = this._priceFormatter,
                        p = this._defaultPriceFormatter,
                        g = this._volumeFormatter,
                        b = (e, o = !0) => o ? `(${e})` : e,
                    ...
                    l.disableChange || (this._setNodesValue(this._textNodes.change, s.change, f), this._setNodesValue(this._textNodes.changePercent, s.change_percent, x), null != s.change && (l.dontDyePrice || this._setChangeFontColor([].concat(this._elements.change, this._elements.changePercent), s.change, l.changeUpFontColor, l.changeDownFontColor, l.changeNeutralFontColor), this._setChangeDirection(this._elements.changeDirection, s.change)), this._setNodesValue(this._textNodes.extHrsChange, s.rch, f), this._setNodesValue(this._textNodes.extHrsChangePercent, s.rchp, x), null != s.rch && (l.dontDyePrice || this._setChangeFontColor([].concat(this._elements.extHrsChange, this._elements.extHrsChangePercent), s.rch, l.changeUpFontColor, l.changeDownFontColor, l.changeNeutralFontColor),
                        this._setChangeDirection(this._elements.extHrsChangeDirection, s.rch))), this._setNodesValue(this._textNodes.prevClose, s.prev_close_price, C), this._setNodesValue(this._textNodes.dividends, e.dividends_yield, (e => null == e ? c.PLACE_HOLDER : i.format(e, {
                        signPositive: l.signPositive,
                        signNegative: l.signNegative
                    })), !0);
                    let E = (0, u.getTranslatedSymbolDescription)(s);
                    ...
                    })), this._elements.lastPeriod.length && void 0 === e["reference-last-period"] && this._setTextsContent(this._elements.lastPeriod, "—"), this._setLastValue(s.last_price, s.minmove2, C), this._setNodesValue(this._textNodes.extHrsClose, s.rtc, C), s.rtc && this._highlighters.extHrsClose.show(s.rtc), s.industry && this._setTextsContent(this._elements.industry, e.industry, (e => e)), s.sector && this._setTextsContent(this._elements.sector, e.sector), this._elements.sessionStatus && s.current_session && (this._sessionStatusInstances ? this._sessionStatusInstances.forEach((e => e.setStatus(s.current_session))) : this._sessionStatusInstances = this._elements.sessionStatus.map((o => new d.MarketStatusIndicator({
                        classSuffix: this._options.sessionStatusClassSuffix,
                        el: o,
                        short: !0,
                        data: {
                    ...
                    })))), this._setNodesValue(this._textNodes.open, s.open_price, C), this._setNodesValue(this._textNodes.high, s.high_price, C), this._setNodesValue(this._textNodes.low, s.low_price, C), this._setNodesValue(this._textNodes.eps, e.earnings_per_share_basic_ttm, w, !0), this._setNodesValue(this._textNodes.priceEarnings, e.price_earnings_ttm, w, !0), this._setNodesValue(this._textNodes.marketCap, e.market_cap_basic, k, !0), this._setNodesValue(this._textNodes.volume, e.volume, k, !0);
                ...
                }, k.prototype._setNodesValue = function(e, o, t, r) {
                    if (null != o || r)
                        for (var s = "function" == typeof t ? t(o) : o, l = 0; l < e.length; l++) e[l].nodeValue = s
                }, k.prototype._setTextsContent = function(e, o, t) {
                    if (e && e.length && o)
                        for (var r = "function" == typeof t ? t(o) : o, s = 0; s < e.length; s++) e[s].textContent = r
                }, k.prototype._setLastValue = function(e, o, t) {
                    if (null == e) return;
                    const r = "function" == typeof t ? t(e) : String(e);
                    if (r === this._lastPriceFormatted) return;
                    const [s, l, i] = this._options.lastPriceHighlightDiffOnly ? this._getLastValueStringDiff(this._lastPriceFormatted, r) : ["", r, ""], a = s, n = this._calculatePipetteDigits(o), [c, d] = this._options.lastPriceLastCharSup && n ? [l.slice(0, -n), l.slice(-n)] : [l, ""];
                    this._options.lastPriceHighlightDiffOnly && (this._isVolumeFormat && this._changeVolumeLetter.call(this, i), this._setNodesValue(this._textNodes.last, a)), this._setNodesValue(this._textNodes.lastHighlight, c), this._setNodesValue(this._textNodes.lastSup, d), this._lastPriceFormatted = r
                }, k.prototype._getChangeVolumeLetterCallback = function() {
                    let e;
                    return function(o) {
                ...
                }, k.prototype._getLastValueStringDiff = function(e, o) {
                    if (e === o) {
                        const [e, t] = w(o);
                        return [e, "", t]
                    }
                    let t = 0;
                    for (; e[t] === o[t];) t++;
                    const [r, s] = w(o.slice(t));
                    return [o.slice(0, t), r, s]
                }, k.prototype._calculatePipetteDigits = function(e) {
                    return e && e !== this._lastMinMove && (this._lastMinMove = e), this._lastMinMove ? ("" + this._lastMinMove).length - 1 : 0
                },
                k.prototype._setChangeFontColor = function(e, o, t, r, s) {
                    for (var l = a.PriceColorer.formatSign(o, {
                            up: t,
                            down: r,
                            neutral: s
                        }), i = 0; i < e.length; i++) e[i].style.color = l
                }, k.prototype._setChangeDirection = function(e, o) {
                ...
                }, k.prototype._setCache = function(e, o) {
                    null == o ? delete this._cache[e] : this._cache[e] = o
                }, k.prototype._getCache = function(e) {
        ...
        927435: (e, o, t) => {
            ...
            function s(e) {
                ...
                }(e.currency_code || e.value_unit_id || "");
                switch (e.measure) {
                    case "price":
                    case "unit":
                        o = [s, e.unit_id];
