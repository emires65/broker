    ...
    [45953], {
        960521: function(r, t, e) {
            ...
            ! function() {
                ...
                function w(r, t, e, n) {
                    var i = r.c;
                    if (e === p && (e = r.constructor.RM), 0 !== e && 1 !== e && 2 !== e && 3 !== e) throw Error(h);
                ...
                a.abs = function() {
                    ...
                    var t = this,
                        ...
                        s = t.s == r.s ? 1 : -1,
                        c = e.DP;
                    if (c !== ~~c || c < 0 || c > o) throw Error(u);
                    if (!i[0]) throw Error(l);
                    if (!n[0]) return r.s = s, r.c = [r.e = 0], r;
                    var f, h, a, v, g, d = i.slice(),
                        m = f = i.length,
                        E = n.length,
                        b = n.slice(0, f),
                        P = b.length,
                        ...
                        A = 0,
                        D = c + (y.e = t.e - r.e) + 1;
                    for (y.s = s, s = D < 0 ? 0 : D, d.unshift(0); P++ < f;) b.push(0);
                    do {
                        for (a = 0; a < 10; a++) {
                        ...
                        x[A++] = v ? a : ++a, b[0] && v ? b[P] = n[m] || 0 : b = [n[m]]
                    } while ((m++ < E || b[0] !== p) && s--);
                    return x[0] || 1 == A || (x.shift(), y.e--, D--), A > D && w(y, D, e.RM, b[0] !== p), y
                }, a.eq = function(r) {
                    return 0 === this.cmp(r)
                }, a.gt = function(r) {
                    return this.cmp(r) > 0
                    ...
                    var t = this,
                        ...
                        n = e,
                        i = r < 0;
                    if (r !== ~~r || r < -1e6 || r > s) throw Error(f + "exponent");
                    for (i && (r = -r); 1 & r && (n = n.times(t)), r >>= 1;) t = t.times(t);
                    return i ? e.div(n) : n
                }, a.prec = function(r, t) {
                    if (r !== ~~r || r < 1 || r > o) throw Error(f + "precision");
                    return w(new this.constructor(this), r, t)
                }, a.round = function(r, t) {
                    if (r === p) r = 0;
                    else if (r !== ~~r || r < -o || r > o) throw Error(u);
                    return w(new this.constructor(this), r + this.e + 1, t)
                }, a.sqrt = function() {
                    var r, t, e, n = this,
                        i = n.constructor,
                        o = n.s,
                    ...
                    do {
                        e = r, r = f.times(e.plus(n.div(e)))
                    } while (e.c.slice(0, s).join("") !== r.c.slice(0, s).join(""));
                    return w(r, (i.DP -= 4) + r.e + 1, i.RM)
                    ...
                    var e = this,
                        n = e.c[0];
                    if (r !== p) {
                        if (r !== ~~r || r < 0 || r > o) throw Error(u);
                        for (e = w(new e.constructor(e), ++r, t); e.c.length < r;) e.c.push(0)
                    }
                    return g(e, !0, !!n)
                    ...
                    if (r !== p) {
                        if (r !== ~~r || r < 0 || r > o) throw Error(u);
                        for (r = r + (e = w(new e.constructor(e), r + e.e + 1, t)).e + 1; e.c.length < r;) e.c.push(0)
                    }
                    return g(e, !1, !!n)
                }, a.toJSON = a.toString = function() {
                    var r = this,
                        t = r.constructor;
                    return g(r, r.e <= t.NE || r.e >= t.PE, !!r.c[0])
                }, a.toNumber = function() {
                    var r = Number(g(this, !0, !0));
                    if (!0 === this.constructor.strict && !this.eq(r.toString())) throw Error(c + "Imprecise conversion");
                    return r
                    ...
                    if (r !== p) {
                        if (r !== ~~r || r < 1 || r > o) throw Error(f + "precision");
                        for (e = w(new n(e), r, t); e.c.length < r;) e.c.push(0)
                    }
                    return g(e, r <= e.e || e.e <= n.NE || e.e >= n.PE, !!i)
                }, a.valueOf = function() {
                    var r = this,
                        t = r.constructor;
                    if (!0 === t.strict) throw Error(c + "valueOf disallowed");
                    return g(r, r.e <= t.NE || r.e >= t.PE, !0)
                }, i = function r() {
                    function t(e) {
                        var n = this;
                        ...
                        if (e instanceof t) n.s = e.s, n.e = e.e,
                            ...
                            if ("string" != typeof e) {
                                if (!0 === t.strict) throw TypeError(f + "number");
                                e = 0 === e && 1 / e < 0 ? "-0" : String(e)
                            }! function(r, t) {
                                var e, n, i;
                                if (!v.test(t)) throw Error(f + "number");
                ...
                }(), i.default = i.Big = i, void 0 === (n = function() {
                    return i
